...
def calculate_best_way(request):
    ...
    if request.method == 'POST':
        ...
        weather = request.POST.get('weather', 'sun')
        time_period = request.POST.get('time_period', '10-16')
        ...
        best_way = map_instance.get_fastest_path(start_point, end_point, weather, time_period)

        return render(request, 'way_result.html',
                      {'start_point': start_point, 'end_point': end_point, 'best_way': best_way})
